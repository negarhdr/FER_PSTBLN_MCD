...
class ST_BLN_block(nn.Module):
    def __init__(self, topology, blocksize, layer_ind, num_point, stride=1, residual=True):
...
class PSTBLN(nn.Module):
    def __init__(self, topology, blocksize, num_class=6, num_point=51, num_person=1, in_channels=2):
        ...
        self.layers = nn.ModuleDict(
            {'l{}'.format(i): ST_BLN_block(self.topology, self.block_size, i, num_point=num_point)
